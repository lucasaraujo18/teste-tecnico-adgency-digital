...
Route::post('user/confirm-email', [App\Http\Controllers\UserController::class, 'verifyAccount'])->name('user.verifyCode')->middleware('auth');
...
//GitHub
Route::get('github', [App\Http\Controllers\GitHubController::class, 'index'])->name('github.index')->middleware('auth');
...
Route::get('github/gitRepos', [App\Http\Controllers\GitHubController::class, 'gitUserRepo'])->name('gitUserRepo')->middleware('auth');
